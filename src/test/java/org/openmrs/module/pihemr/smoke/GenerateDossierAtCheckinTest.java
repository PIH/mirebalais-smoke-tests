...
import org.openmrs.module.pihemr.smoke.pageobjects.ArchivesRoomApp;
...
public class GenerateDossierAtCheckinTest extends DbTest {
	...
	public void shouldCreateDossierLocallyAtCheckinWhenDossierIsMissing() throws Exception {
		...
		new ZlCentralLoginPage(driver).logIn("admin", new SmokeTestProperties().getAdminUserPassword(), "Chimyoterapi");
